      ...
      <div className="flex h-screen justify-center items-center">
        <div className="flex flex-col items-center gap-2 bg-fundoPaginaSecundaria rounded-xl md:w-[630px]  md:h-[780px] md:px-20 md:py-8">
          <Image
            ...
            height={150}
          />
          <h1 className="text-2xl font-semibold text-textoBranco text-center mb-4">Entre com sua conta</h1>
          ...
          <button className="text-textoCinza text-md py-4 hover:brightness-125 transition">
            ...
            <div className="flex items-center justify-center">
              <hr className="linha my-8"/> <span className="text-textoCinza mx-2 text-lg"> ou </span> <hr className="linha"/>
            </div>
            <button className="self-center">
              <Image src="/google-icon.svg" alt={"google-icon"} width={60} height={60} />
            </button>
          ...
          <span className="text-textoCinza text-sm">Ou faça login pelo Google clicando no G acima</span>
        </div>
      </div>
    );
  }
