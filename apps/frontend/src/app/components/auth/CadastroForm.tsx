import { EnvelopeIcon, EyeIcon, LockClosedIcon, PhoneIcon, UserCircleIcon } from "@heroicons/react/24/outline";
...
export default function CadastroForm (){
    return (
      <div className="flex flex-1 flex-col justify-evenly w-full">
        ...
        <Button className="verde mt-8">
          Cadastrar-se
        </Button>

        <div className="text-center text-textoBranco text-lg leading-5">
          <span>Já possui uma conta? </span>
          <Link href={"/login"} className="text-verde outline-verde hover:brightness-110 transition">
            Faça login
          </Link>
        </div>
      </div>
